...
const SOURCE_CSS = resolve(PROJECT_DIR, "node_modules/katex/dist/katex.min.css");
const SOURCE_FONTS_DIR = resolve(PROJECT_DIR, "node_modules/katex/dist/fonts");
...
function readKatexPackageJson(): KatexPackageJson {
  const packageJsonPath = resolve(PROJECT_DIR, "node_modules/katex/package.json");
