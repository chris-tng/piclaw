...
- [ ] **Refactor `src/channels/web.ts` into narrower services**
  ...
  - Pending: split remaining `web.ts` orchestration around interaction/message write flows and residual state adapters.
